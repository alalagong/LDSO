...
std::string source = "/media/gong/win_file/Dataset/neu_mono/19090202";
std::string output_file = "./results.txt";
std::string calib = "./examples/neu/neu.txt";
...
int main(int argc, char **argv) {
    ...
    shared_ptr<ImageFolderReader> reader(
            new ImageFolderReader(ImageFolderReader::NEU, source, calib, "", ""));    // no gamma and vignette
